...
CREATE TABLE public.questions (
    ...
    submit_at timestamp without time zone DEFAULT '2021-12-13 14:37:40.624465'::timestamp without time zone NOT NULL,
...
COPY public.questions (id, question, answered, submit_at, answered_at, answered_by, answer, tags, user_id) FROM stdin;
\.
...
COPY public.users (id, class, student) FROM stdin;
\.
